    ...
    <PageShell crumbs={[
      ...
      <section className="container py-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Link to="/games/cricket" className="rounded-xl border border-primary/20 bg-gradient-card p-4 transition-all hover:border-primary/40 hover:shadow-glow-gold">
          ...
          <Link to="/games/casino" className="rounded-xl border border-primary/20 bg-gradient-card p-4 transition-all hover:border-primary/40 hover:shadow-glow-gold">
            <h3 className="font-semibold text-lg">Live Casino Games</h3>
            <ChevronRight className="mt-2 h-4 w-4 text-primary" />
          </Link>
        </div>
      </section>
